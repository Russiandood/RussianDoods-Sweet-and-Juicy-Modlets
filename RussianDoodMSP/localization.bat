...
IF EXIST "Localization.txt" goto partlyconfirmed
...
echo.
echo.
echo Well... it seems we are missing the localization file needed to continue. Make sure you run this script with the localization file to append, or don't rename it. 
echo.
goto end
:confirmed
color 0C
...
echo.
for %%I in (.) do set CurrDirName=%%~nxI
echo This will load up the localization data for the mod "RussianDood Makes Solar Panels".
echo.
...
FINDSTR /v "solarCell solarPanel solarbank cntCollapsedSolarbank -RussianDoodMSP" LocalizationTEMP.txt > "../../data/config/Localization.txt"
